...
public static class ItemsList
{
    ...
    private static void InitializeItems()
    {
        ...
        items.Add(new Boster(68, "booster_intelligence", 100, 0, Quality.Rare, 500, "_", AllStats.Intelligence, 2, TypeItem.Booster));
        items.Add(new Item(69, "material_syringe", 40, 0, Quality.Common, 12, "_", TypeItem.Material));
        items.Add(new Boster(70, "booster_strength", 100, 0, Quality.Rare, 500, "_", AllStats.Strength, 2, TypeItem.Booster));
        items.Add(new Boster(71, "booster_agillity", 100, 0, Quality.Rare, 500, "_", AllStats.Agility, 2, TypeItem.Booster));
        //PrintItemList();
    }
