...
public class ItemsList : MonoBehaviour
{
    ...
    private void InitializeItems()
    {
        ...
        items.Add(new Sword(1, "sword_gods_slayer", 1, spriteList[1], Quality.Legendary, "___", false, 2, damageT.Cutting, 3, 1.5f));
        items.Add(new Gun(2, "gun_makarov", 1, spriteList[2], Quality.Rare, "___", true, 10f, damageT.Cutting, 2, 2f, 6f, 0));
