...
public class PickaxeLogic: MeleWeaponLogic
{
    ...
    protected override void MeleeAttack()
    {
        ...
        StartCoroutine(PiackaxeAttackCoroutine(idSound));
    }
    ...
    protected IEnumerator PiackaxeAttackCoroutine(int idSound)
    {
        ...
        //ManualHitDetection(midAttackPos, 0.8f); // ← радиус подбора (можно варьировать)
